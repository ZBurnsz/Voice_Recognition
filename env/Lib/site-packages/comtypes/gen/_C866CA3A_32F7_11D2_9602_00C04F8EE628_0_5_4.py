...
__all__ = [
    ...
    'SAFT22kHz16BitStereo', 'SAFTADPCM_11kHzStereo', 'SITooSlow',
    'SVPAlert', 'SpeechVoiceCategoryTTSRate',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SDKOpenKey',
    'ISpEventSink', 'SECFIgnoreCase', 'ISpRecoGrammar2',
    'DISPID_SLWWord', 'DISPID_SLWsCount', 'ISpVoice', 'SPEI_MIN_SR',
    'SAFT22kHz16BitMono', 'SpMMAudioIn', 'ISpeechObjectTokenCategory',
    'DISPID_SWFESamplesPerSec', 'SpeechCategoryAppLexicons',
    'SPCS_DISABLED', 'SPEI_TTS_BOOKMARK', 'SVP_15',
    'DISPID_SpeechPhraseProperty', 'DISPID_SASNonBlockingIO',
    'DISPID_SVSLastResult', 'SRSEDone', 'SAFTADPCM_22kHzMono',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SRCERecognition',
    'SPEI_HYPOTHESIS', 'ISpeechGrammarRuleStateTransition',
    'SP_VISEME_9', 'SPWT_PRONUNCIATION', 'SAFT22kHz8BitMono',
    'SPRST_ACTIVE_ALWAYS', 'ISpEventSource', 'ISpeechRecoResultTimes',
    'DISPID_SRGCmdSetRuleState', 'DISPID_SOTGetStorageFileName',
    'SRSInactiveWithPurge', 'SPEI_VISEME', 'SVP_11',
    'SpeechGrammarState', 'ISpPhrase', 'DISPID_SPAsItem',
    'SPFM_OPEN_READWRITE', 'SRAExport', 'DISPID_SRIsShared',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SpeechCustomStream',
    'SpLexicon', 'SPEI_FALSE_RECOGNITION', 'DISPID_SpeechFileStream',
    'DISPID_SVEEnginePrivate', 'SpeechVisemeFeature',
    'SAFTCCITT_ALaw_22kHzMono', 'SWTAdded', 'DISPID_SDKGetlongValue',
    'DISPID_SRGetPropertyString', 'SAFTADPCM_44kHzStereo',
    'SAFT32kHz16BitMono', 'SPEVENT', 'SPEI_RECO_OTHER_CONTEXT',
    'SDTLexicalForm', 'SRSEIsSpeaking', 'DISPID_SGRsAdd',
    'eLEXTYPE_PRIVATE20', 'SPAR_High', 'DISPID_SREmulateRecognition',
    'SpeechRecoContextState', 'SVP_18', 'DISPID_SGRsFindRule',
    'ISpStreamFormat', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    ...
    'SP_VISEME_11', 'DISPID_SRRSetTextFeedback',
    'SpeechAudioProperties', 'DISPID_SpeechMMSysAudio',
    'IInternetSecurityManager', 'SPSVerb', 'DISPID_SOTDataKey',
    'DISPID_SABIEventBias', 'DISPID_SVEBookmark',
    'DISPID_SGRsCommitAndSave', 'eLEXTYPE_RESERVED7',
    'ISpeechXMLRecoResult', 'SPEI_RESERVED3', 'SPCONTEXTSTATE',
    'SpeechRecoEvents', 'DISPID_SLGetGenerationChange',
    'DISPID_SRGCmdLoadFromFile', 'ISpPhoneticAlphabetSelection',
    'SPEI_RESERVED6', 'SpeechRecognizerState', 'SDTRule',
    ...
    'SpeechVoiceSkipTypeSentence', 'SPAS_RUN', 'DISPID_SPILanguageId',
    'SPSHT_OTHER', 'DISPID_SpeechAudio', 'DISPID_SRCEPhraseStart',
    'DISPID_SRCEventInterests', 'DISPID_SRRecognizer',
    'SpeechTokenIdUserLexicon', 'SPEI_SR_AUDIO_LEVEL',
    'SpSharedRecoContext', 'SpeechWordType', 'eLEXTYPE_PRIVATE15',
    'DISPIDSPTSI', 'DISPID_SRGState', 'SpeechGrammarTagWildcard',
    'SSTTWildcard', 'DISPID_SOTCEnumerateTokens',
    'ISpeechLexiconPronunciation', 'SPPHRASEELEMENT',
    'SpeechVisemeType', 'DISPID_SLPPhoneIds', 'SPSMF_SAPI_PROPERTIES',
    'ISpeechTextSelectionInformation', 'ISpMMSysAudio',
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SWFEAvgBytesPerSec',
    'DISPID_SLWPronunciations', 'DISPID_SAVolume',
    'DISPID_SRGCmdLoadFromResource', 'ISpDataKey', 'DISPID_SGRSRule',
    'SPCS_ENABLED', 'DISPID_SVSPhonemeId', 'SRAONone',
    'DISPID_SRGRules', 'DISPID_SPIProperties',
    'DISPID_SRCEStartStream', 'SREStreamStart',
    'DISPID_SASCurrentDevicePosition', 'SRAInterpreter',
    'DISPID_SVGetVoices', 'SPEI_END_SR_STREAM',
    'SpeechEngineProperties', 'ISpeechGrammarRule',
    'SVSFNLPSpeakPunc', 'SPEI_PROPERTY_NUM_CHANGE', 'SVEAudioLevel',
    'DISPID_SVSInputSentenceLength', 'SPEI_MIN_TTS', 'SPEI_MAX_TTS',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SRRRecoContext',
    'SPRECORESULTTIMES', 'SVP_13', 'SGDisplay', 'SPRECOGNIZERSTATUS',
    'DISPID_SPIEngineId', 'SDA_Consume_Leading_Spaces', 'SVP_12',
    '__MIDL_IWinTypes_0009', 'SPEI_RESERVED1', 'SPVOICESTATUS',
    'DISPID_SpeechPhraseBuilder', 'DISPID_SRCRequestedUIType',
    'eLEXTYPE_PRIVATE1', 'SRAImport', 'eLEXTYPE_RESERVED10',
    'SpInprocRecognizer', 'SP_VISEME_12', 'SAFT8kHz8BitMono',
    'DISPID_SABufferInfo', 'SPLO_STATIC',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SRGIsPronounceable',
    'Speech_StreamPos_RealTime', 'SAFT24kHz8BitMono',
    'eLEXTYPE_PRIVATE13', 'SPINTERFERENCE_TOOLOUD',
    'SRADefaultToActive', 'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SMSADeviceId', 'SAFTCCITT_ALaw_44kHzMono', 'SVP_3',
    'DISPID_SRCCreateResultFromMemory', 'SpeechRuleAttributes',
    'SPCT_SUB_COMMAND', 'DISPID_SDKSetLongValue',
    'SAFT12kHz16BitStereo', 'SpeechTokenShellFolder',
    'SPEI_SOUND_END', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SRCEPropertyNumberChange', 'SGSEnabled',
    'SPWAVEFORMATTYPE', 'DISPID_SpeechGrammarRules', 'SVEViseme',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SRCBookmark',
    'ISpLexicon', 'ISpRecoCategory', 'DISPID_SPRFirstElement',
    'SDTDisplayText', 'SAFT12kHz16BitMono', 'SAFTADPCM_11kHzMono',
    'SDTProperty', 'DISPID_SPAs_NewEnum',
    'DISPID_SpeechPhraseReplacement', 'SPGRAMMARSTATE',
    'eLEXTYPE_PRIVATE4', 'DISPID_SRSClsidEngine', 'STCLocalServer',
    'DISPID_SDKSetStringValue', 'DISPID_SRCEInterference',
    'SRCS_Disabled', 'SpInProcRecoContext', 'DISPID_SPIGetText',
    'SPEI_ADAPTATION', 'STSF_CommonAppData', 'STSF_LocalAppData',
    'SINone', 'SpeechAudioFormatType', 'DISPID_SPRText',
    'ISpeechLexicon', 'SVP_6', 'SAFT48kHz16BitStereo',
    'DISPID_SPPChildren', 'SPBOOKMARKOPTIONS', 'SP_VISEME_3',
    'SPSHT_NotOverriden', 'DISPID_SPRuleChildren',
    'DISPID_SLPPartOfSpeech', 'DISPID_SRCCmdMaxAlternates',
    'eLEXTYPE_PRIVATE5', 'SVP_9', 'DISPID_SRGReset',
    'DISPID_SRCAudioInInterferenceStatus', 'DISPID_SLPLangId',
    'DISPID_SPEsItem', 'SVSFPersistXML', 'ISpStream',
    'DISPID_SRGetRecognizers', 'SVP_8', 'DISPID_SPAsCount',
    'eLEXTYPE_RESERVED4', 'SP_VISEME_18', 'ISpeechRecoResultDispatch',
    'DISPID_SpeechObjectTokenCategory', 'ISpAudio',
    'SPAUDIOBUFFERINFO', 'SAFT16kHz16BitMono', 'SAFT24kHz16BitStereo',
    'SPSNotOverriden', 'SpeechTokenKeyUI', 'SpeechVoiceEvents',
    'SREAllEvents', 'SPRST_NUM_STATES', 'Speech_Default_Weight',
    'SpeechDisplayAttributes', 'SpeechTokenKeyFiles',
    'SPEI_INTERFERENCE', 'DISPID_SLWLangId',
    'SpStreamFormatConverter', 'SpeechMicTraining',
    'Speech_Max_Word_Length', 'DISPID_SRRGetXMLResult',
    'DISPID_SAStatus', 'SLOStatic', 'eLEXTYPE_PRIVATE17',
    ...
    'DISPID_SpeechPhraseReplacements', 'DISPID_SRGetFormat',
    'SVF_Stressed', 'SVP_17', 'SPINTERFERENCE_TOOQUIET',
    'eLEXTYPE_USER_SHORTCUT', 'SRESoundEnd', 'DISPID_SVDisplayUI',
    'SPSMF_UPS', 'SPSERIALIZEDPHRASE', 'IEnumString',
    'DISPID_SDKEnumKeys', 'DISPID_SPRsItem', 'SPDKL_DefaultLocation',
    'SVP_2', 'DISPID_SRGCmdSetRuleIdState', 'ISpPhoneConverter',
    'SpeechLoadOption', 'SRSInactive', 'ISpXMLRecoResult',
    'SITooLoud', 'DISPID_SRCRetainedAudio',
    'DISPID_SpeechAudioFormat', 'SVP_14', 'SPRS_INACTIVE',
    'SVEPrivate', 'SpeechRecoProfileProperties', 'DISPID_SGRClear',
    'eLEXTYPE_PRIVATE16', 'ISpObjectToken', 'DISPID_SPEs_NewEnum',
    'DISPID_SRGSetTextSelection', 'DISPID_SRRGetXMLErrorInfo',
    'SP_VISEME_21', 'DISPID_SPEsCount', 'DISPID_SRCEBookmark',
    'DISPID_SAFType', 'DISPID_SGRAddResource', 'DISPID_SCSBaseStream',
    'DISPID_SVGetAudioInputs', 'DISPID_SGRsCommit',
    'DISPID_SpeechLexicon', 'DISPID_SRCreateRecoContext', 'SPAS_STOP',
    'DISPID_SPCIdToPhone', 'DISPID_SVEWord', 'SpeechAddRemoveWord',
    'SVSFParseAutodetect', 'DISPID_SLPsCount', 'SpeechTokenContext',
    'DISPID_SPRsCount', 'DISPID_SOTCreateInstance',
    'SPSTREAMFORMATTYPE', 'SAFT11kHz8BitMono',
    'DISPID_SDKDeleteValue', 'SDTAudio', 'DISPID_SRGetPropertyNumber',
    'DISPID_SpeechRecoContextEvents', 'SPEI_SENTENCE_BOUNDARY',
    'SPPS_Verb', 'DISPID_SVSInputWordPosition', 'DISPID_SOTCId',
    'DISPID_SOTDisplayUI', 'DISPID_SPEActualConfidence',
    'SpeechPropertyNormalConfidenceThreshold', 'SPEI_RESERVED5',
    'DISPID_SVSInputWordLength', 'DISPID_SOTCDefault', 'SPVISEMES',
    'ISpeechAudioBufferInfo', 'SECFNoSpecialChars', 'SRTStandard',
    'DISPID_SpeechGrammarRuleStateTransitions', 'DISPID_SRCResume',
    'DISPID_SPEDisplayAttributes', 'SPINTERFERENCE',
    'SPSSuppressWord', 'DISPID_SVEAudioLevel',
    'DISPID_SVAudioOutputStream', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SGRId', 'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SPIAudioSizeTime', 'SPPARTOFSPEECH', 'SPDKL_LocalMachine',
    'SPEI_END_INPUT_STREAM', 'ISpeechVoice', 'eLEXTYPE_PRIVATE9',
    'DISPID_SRAudioInputStream', 'SASRun', 'SVEPhoneme',
    'DISPID_SPIElements', 'SINoSignal',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SRRAlternates',
    'DISPID_SRRTStreamTime', 'ISpeechPhraseReplacements',
    'DISPID_SpeechLexiconWords', 'ISpeechObjectToken',
    'DISPID_SGRsCount', 'DISPID_SPPsItem', 'DISPID_SPACommit',
    'SPXRO_Alternates_SML', 'SpMMAudioEnum', 'IStream', 'SPSLMA',
    'SPSERIALIZEDRESULT', 'DISPID_SPPParent',
    'DISPID_SPERetainedStreamOffset', 'eLEXTYPE_PRIVATE11',
    'SVF_None', 'SAFT44kHz16BitStereo', 'SpeechPropertyResponseSpeed',
    'SECLowConfidence', 'SECHighConfidence', 'SLTApp',
    'SDA_No_Trailing_Space', 'DISPID_SRSCurrentStreamPosition',
    'DISPID_SBSRead', 'DISPID_SPIGrammarId', 'DISPID_SGRAttributes',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SPEI_TTS_PRIVATE',
    'SpCustomStream', 'DISPID_SRRAudio', 'ISpeechLexiconWords',
    'DISPID_SPIReplacements', 'SAFT11kHz16BitMono',
    'ISpeechRecoContext', 'DISPID_SOTCSetId',
    'DISPID_SpeechRecognizer', 'SSTTTextBuffer', 'SPPHRASEPROPERTY',
    'SPRECOSTATE', 'STCInprocServer', 'SPPS_LMA',
    'DISPID_SGRSTNextState', 'SPVPRI_ALERT', 'DISPID_SAEventHandle',
    'DISPID_SVRate', 'SP_VISEME_15', 'SVSFIsXML',
    'DISPID_SGRSTs_NewEnum', 'ISpObjectTokenCategory',
    'SAFT44kHz8BitMono', 'ISpeechRecognizer', 'DISPID_SVSpeakStream',
    'DISPID_SPIAudioSizeBytes', 'SAFTDefault', 'DISPID_SFSClose',
    'SpeechFormatType', 'SDTReplacement', 'SREStreamEnd',
    'DISPID_SpeechRecoResult', 'ISpeechWaveFormatEx', 'SVPNormal',
    'DISPID_SpeechVoiceStatus', 'SPFILEMODE', 'SITooFast',
    'SSFMCreate', 'DISPID_SVSyncronousSpeakTimeout',
    'SpeechCategoryAudioIn', 'SAFT16kHz8BitStereo',
    'DISPID_SPEEngineConfidence', 'DISPID_SOTsCount',
    'SDTPronunciation', 'SGRSTTWildcard', 'DISPID_SDKSetBinaryValue',
    'DISPID_SpeechRecoContext', 'DISPID_SLWs_NewEnum',
    'SREPropertyStringChange', 'SGRSTTWord', 'ISpeechPhraseAlternate',
    'DISPID_SVPause', 'DISPID_SLWType', 'eLEXTYPE_USER',
    'SPAUDIOOPTIONS', 'DISPID_SRProfile', 'IInternetSecurityMgrSite',
    'ISpeechMMSysAudio', 'SAFT12kHz8BitStereo', 'SPPS_RESERVED2',
    'DISPID_SRRSaveToMemory', 'SPDKL_CurrentUser', 'SPPS_RESERVED4',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SWFEBlockAlign',
    'eLEXTYPE_PRIVATE7', 'SPCT_COMMAND', 'SAFT48kHz8BitStereo',
    'DISPID_SMSSetData', 'SpeechDiscardType', 'SPCATEGORYTYPE',
    'DISPID_SPCLangId', 'DISPID_SRRSpeakAudio', 'DISPID_SVStatus',
    'SpeechVoiceSpeakFlags', 'SAFT32kHz8BitMono', 'SPFM_CREATE',
    'SpeechDictationTopicSpelling',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SVEPhoneme',
    'DISPID_SLAddPronunciation', 'DISPID_SRCESoundEnd',
    'SPXMLRESULTOPTIONS', 'DISPID_SPPId', 'DISPID_SWFEBitsPerSample',
    'DISPID_SpeechPhoneConverter', 'SGRSTTTextBuffer',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SOTRemove',
    'SpPhraseInfoBuilder', 'DISPIDSPTSI_ActiveLength',
    'SAFT11kHz8BitStereo', 'SpeechPropertyResourceUsage',
    ...
    'SpTextSelectionInformation', 'SAFTNoAssignedFormat',
    'DISPID_SVAlertBoundary', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SRIsUISupported', 'SP_VISEME_20', 'DISPID_SGRSTsCount',
    'ISpeechPhraseProperty', 'SP_VISEME_4', 'SPSFunction',
    'DISPID_SpeechLexiconProns', 'DISPID_SPRuleNumberOfElements',
    'DISPID_SRGSetWordSequenceData', 'SpFileStream',
    'SAFT44kHz16BitMono', 'ISpRecognizer2', 'ISpSerializeState',
    'DISPID_SLGetWords', 'SGRSTTRule', 'SFTSREngine',
    'DISPID_SPPs_NewEnum',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'ISpeechRecoResult',
    'SWTDeleted', 'SP_VISEME_8', 'SPDATAKEYLOCATION',
    'DISPID_SASFreeBufferSpace', 'ISpShortcut',
    'SpeechGrammarWordType', 'SRAORetainAudio', 'SpeechVoicePriority',
    'SWPKnownWordPronounceable', 'SPLEXICONTYPE', 'SVP_1',
    'SP_VISEME_6', 'SGSExclusive', 'SAFTCCITT_ALaw_11kHzStereo',
    'DISPIDSPTSI_SelectionLength', 'SASStop',
    'DISPID_SRSetPropertyString', 'SPADAPTATIONRELEVANCE',
    'ISpProperties', 'SVSFIsNotXML', 'SRTReSent',
    'SpeechCategoryVoices', 'SSFMOpenForRead', 'SDTAlternates',
    'SPBO_NONE', 'SAFT24kHz8BitStereo', 'ISpRecoContext2',
    'SPINTERFERENCE_NOISE', 'SSFMOpenReadWrite',
    'SpeechPropertyLowConfidenceThreshold', 'SpeechPartOfSpeech',
    'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SRGCommit', 'ISpeechAudio',
    ...
    'DISPID_SpeechGrammarRuleStateTransition', 'SPBO_PAUSE',
    'SPPROPERTYINFO', 'SAFTADPCM_8kHzMono', 'DISPID_SBSFormat',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SPWORDTYPE', 'DISPID_SRRTimes',
    'SpeechPropertyAdaptationOn', 'SAFTNonStandardFormat',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SPAPhraseInfo',
    'SpeechBookmarkOptions', 'SVP_10', 'ISpeechMemoryStream',
    'DISPID_SpeechMemoryStream', 'ISpRecoResult', 'ISpGrammarBuilder',
    'SVEStartInputStream', 'DISPID_SWFEFormatTag', 'SBONone',
    'SPSModifier', 'SpeechTokenKeyAttributes', 'STCRemoteServer',
    'SAFT8kHz16BitStereo', 'SGDSInactive', 'SGDSActive',
    'DISPID_SRCEAudioLevel', 'SPINTERFERENCE_TOOFAST',
    'SWPUnknownWordPronounceable', 'SRESoundStart', 'SVP_4',
    'SpeechRetainedAudioOptions', 'SDKLCurrentConfig',
    'DISPID_SPPEngineConfidence', 'DISPID_SGRsDynamic',
    'ISpeechPhraseAlternates', 'SAFTText', 'eLEXTYPE_APP',
    'DISPID_SVEVoiceChange', 'DISPID_SpeechDataKey', 'SPCT_SLEEP',
    'DISPID_SPRules_NewEnum', 'DISPID_SVESentenceBoundary',
    'SVEVoiceChange', 'SREHypothesis', 'DISPID_SLPs_NewEnum',
    ...
    'SPEI_SR_RETAINEDAUDIO', 'SpPhoneConverter', 'DISPID_SVVoice',
    'SAFTExtendedAudioFormat', 'SGPronounciation', 'SRSActiveAlways',
    'DISPID_SRCState', 'ISpeechPhraseInfoBuilder', 'SREStateChange',
    'SPSHORTCUTTYPE', 'ISpeechObjectTokens', 'DISPID_SVIsUISupported',
    'SP_VISEME_10', 'ISpeechRecoResult2', 'SPPS_Interjection',
    'SpeechStreamSeekPositionType', 'DISPID_SDKDeleteKey',
    'DISPID_SpeechRecoResultTimes', 'SpObjectToken', 'SPLOADOPTIONS',
    'DISPID_SVEventInterests', 'DISPID_SASCurrentSeekPosition',
    'DISPID_SVGetProfiles', 'DISPID_SRAudioInput', 'SPWT_LEXICAL',
    'DISPID_SpeechVoiceEvent', 'eLEXTYPE_PRIVATE19', 'ISpRecoContext',
    'tagSTATSTG', 'SAFT11kHz16BitStereo', 'DISPID_SWFEChannels',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SRCRecognizer',
    'SAFTGSM610_44kHzMono', 'SAFTCCITT_uLaw_11kHzStereo',
    'ISpObjectWithToken', 'SVP_21', 'ISpeechDataKey',
    'SpResourceManager', 'SPWORD', 'ISpeechPhraseElements',
    'DISPID_SpeechBaseStream', 'SBOPause', 'DISPID_SRCVoice',
    'eLEXTYPE_PRIVATE8', 'SDKLCurrentUser',
    'SWPUnknownWordUnpronounceable', 'SPSEMANTICFORMAT', 'SPWORDLIST',
    'SVP_19', 'SpeechInterference', 'SSSPTRelativeToCurrentPosition',
    'DISPID_SRGDictationLoad', 'DISPID_SOTRemoveStorageFileName',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SOTs_NewEnum',
    'DISPID_SFSOpen', 'SpNullPhoneConverter',
    'SpeechCategoryAudioOut', 'SVSFPurgeBeforeSpeak',
    'SPEI_REQUEST_UI', 'SREBookmark', 'DISPID_SPRulesCount',
    'SpeechGrammarTagDictation', 'ISpeechFileStream',
    'SPAO_RETAIN_AUDIO', 'SpeechRegistryLocalMachineRoot',
    'SpSharedRecognizer', 'SpeechEngineConfidence', 'DISPID_SOTId',
    'SVSFVoiceMask', 'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SVSLastBookmarkId', 'SGDSActiveUserDelimited',
    ...
    'SP_VISEME_19', 'eLEXTYPE_RESERVED6', 'ISpeechPhraseReplacement',
    'DISPID_SVAudioOutput', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'STSF_FlagCreate', 'SP_VISEME_0', 'SVSFParseMask',
    'SPSHORTCUTPAIRLIST', 'SPSEMANTICERRORINFO', 'SAFT8kHz8BitStereo',
    'SAFT48kHz16BitMono', 'DISPID_SPPsCount', 'SECFIgnoreKanaType',
    'SRSActive', 'SPRS_ACTIVE', 'SITooQuiet', 'DISPID_SOTCategory',
    'DISPIDSPTSI_ActiveOffset', 'ISpeechPhoneConverter',
    'DISPID_SRSetPropertyNumber', 'DISPID_SVPriority',
    'DISPID_SRSAudioStatus', 'ISpeechAudioFormat', 'DISPID_SPPName',
    'ISpNotifyTranslator', 'SAFTCCITT_uLaw_8kHzStereo',
    'SPBINARYGRAMMAR', 'SpObjectTokenCategory', 'SPGS_DISABLED',
    'SSSPTRelativeToEnd', 'SPPS_RESERVED1', 'SPPHRASE',
    'SPSHORTCUTPAIR', 'SpeechTokenValueCLSID', 'DISPID_SRRTLength',
    'DISPID_SBSSeek', 'DISPID_SABIMinNotification',
    'SpeechCategoryPhoneConverters', 'SDKLDefaultLocation',
    'SRTSMLTimeout', 'SPINTERFERENCE_NOSIGNAL', 'ISequentialStream',
    'SPINTERFERENCE_NONE', 'DISPID_SGRSAddWordTransition',
    'SPCT_SUB_DICTATION',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'ISpeechPhraseProperties', 'DISPID_SASetState', 'SPPS_RESERVED3',
    'SpeechAudioVolume', 'SP_VISEME_14', 'SAFTGSM610_8kHzMono',
    'SPAS_PAUSE', 'ISpeechPhraseElement',
    'SPRS_ACTIVE_USER_DELIMITED', 'SREAudioLevel',
    'DISPID_SPISaveToMemory', 'SGRSTTEpsilon', 'SpeechUserTraining',
    'ISpRecognizer3', 'SPRULE', 'ISpPhraseAlt', 'ISpRecognizer',
    'SVSFDefault', 'DISPID_SpeechLexiconPronunciation',
    'SPSMF_SRGS_SAPIPROPERTIES', 'DISPID_SRCEEnginePrivate',
    'DISPID_SVVolume', 'DISPID_SVSpeak', 'DISPID_SVEStreamEnd',
    'UINT_PTR', 'SAFT48kHz8BitMono', 'ISpeechPhraseRules',
    'DISPID_SPEAudioSizeBytes', '_ISpeechRecoContextEvents',
    'SRTExtendableParse', 'DISPID_SRCSetAdaptationData',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'DISPID_SPPConfidence',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SDKCreateKey', '_RemotableHandle',
    'SSSPTRelativeToStart', 'DISPID_SPELexicalForm',
    'DISPID_SPRuleId', 'SpeechCategoryRecognizers',
    'SPPS_NotOverriden', 'SpWaveFormatEx', 'SPEI_RECO_STATE_CHANGE',
    'DISPID_SGRSTWeight', 'SpeechSpecialTransitionType',
    'DISPID_SpeechPhraseElements', 'SpeechStreamFileMode',
    'SVEBookmark', 'DISPID_SpeechLexiconWord', 'DISPID_SGRsItem',
    'SAFT16kHz8BitMono', 'SRERecoOtherContext',
    'DISPID_SPRNumberOfElements', 'SAFT32kHz8BitStereo', 'SASClosed',
    'DISPID_SAFGuid', 'ISpeechCustomStream',
    'ISpPhoneticAlphabetConverter', 'SpCompressedLexicon',
    'SPBO_TIME_UNITS', 'eLEXTYPE_RESERVED9', 'DISPID_SVSLastBookmark',
    'SPPS_Unknown', '_ISpeechVoiceEvents',
    'SAFTCCITT_ALaw_44kHzStereo', 'SVSFNLPMask',
    'SAFT44kHz8BitStereo', 'DISPID_SRSNumberOfActiveRules',
    'SDA_Two_Trailing_Spaces', 'SAFTCCITT_ALaw_8kHzStereo',
    'DISPID_SGRs_NewEnum', 'DISPID_SPRuleName',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SPARecoResult',
    'SpeechGrammarTagUnlimitedDictation', 'SPINTERFERENCE_TOOSLOW',
    'SP_VISEME_5', 'SAFTCCITT_ALaw_11kHzMono',
    'DISPID_SRCESoundStart', 'SPWF_INPUT',
    'SAFTCCITT_ALaw_22kHzStereo', 'SpNotifyTranslator',
    'SECFIgnoreWidth', 'SPSInterjection', 'DISPID_SRState',
    'SP_VISEME_13', 'DISPID_SRGCmdLoadFromMemory',
    'SPWORDPRONUNCIATIONLIST', 'DISPID_SOTGetDescription',
    'SPEI_MAX_SR', 'SPWT_DISPLAY', 'SPVPRIORITY',
    'SPFM_CREATE_ALWAYS', 'DISPID_SVEViseme', 'SPRST_INACTIVE',
    'DISPID_SpeechPhraseInfo', 'SVP_16', 'SpStream',
    'DISPID_SRCERequestUI', 'SRATopLevel', 'SVP_20',
    'DISPID_SOTSetId', 'SREFalseRecognition',
    'DISPIDSPTSI_SelectionOffset', 'SPPS_Function', 'SP_VISEME_16',
    'eLEXTYPE_PRIVATE10', 'SPPS_Noncontent', 'DISPID_SMSALineId',
    'SAFT12kHz8BitMono', 'SPEI_RECOGNITION',
    'SAFTCCITT_uLaw_44kHzStereo', 'ISpeechBaseStream',
    'ISpeechPhraseRule', 'DISPID_SOTCGetDataKey', 'SpAudioFormat',
    'SPAS_CLOSED', 'eLEXTYPE_PRIVATE6',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SVWaitUntilDone',
    'SDTAll', 'SPEI_SR_BOOKMARK', 'ISpeechAudioStatus', 'SPAR_Medium',
    'SP_VISEME_17', 'ISpeechGrammarRuleState', 'SRERecognition',
    'eLEXTYPE_RESERVED8', 'DISPID_SPPValue', 'DISPID_SGRInitialState',
    'SAFTADPCM_22kHzStereo', 'DISPID_SPIRule',
    'DISPID_SPANumberOfElementsInResult', 'SpeechRuleState',
    'SVEWordBoundary', 'SPAUDIOSTATE', 'eWORDTYPE_DELETED',
    'DISPID_SPRuleParent', 'SPPHRASERULE', 'DISPID_SGRSTRule',
    'SLODynamic', 'eLEXTYPE_PRIVATE3', 'SAFT24kHz16BitMono',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SGRSTransitions',
    'SPVPRI_NORMAL', 'SRTAutopause', 'SVF_Emphasis',
    'DISPID_SPRulesItem', 'DISPID_SRCCreateGrammar',
    'DISPID_SLGetPronunciations', 'SVSFlagsAsync',
    'SAFTGSM610_11kHzMono', 'STCInprocHandler', 'SPSUnknown',
    'SPFM_NUM_MODES', 'SpShortcut', 'DISPID_SRCRetainedAudioFormat',
    'DISPID_SPEAudioSizeTime', 'DISPID_SPIAudioStreamPosition',
    'DISPID_SRRAudioFormat', 'DISPID_SVSkip', 'SAFT16kHz16BitStereo',
    'DISPID_SLGenerationId', 'SVP_7', 'DISPID_SMSAMMHandle',
    'DISPID_SpeechPhraseAlternates', 'ISpResourceManager', 'SASPause',
    'SVP_0', 'STSF_AppData', 'SPWF_SRENGINE', 'DISPID_SLWsItem',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet', 'SRADynamic',
    'SGRSTTDictation', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPID_SGRSTsItem', 'SPPS_Noun', '_SPAUDIOSTATE', 'SRTEmulated',
    'SVSFParseSsml', 'DISPID_SPRs_NewEnum', 'ISpeechLexiconWord',
    'DISPID_SRCERecognizerStateChange', 'SINoise',
    'DISPID_SRGRecoContext', 'DISPID_SAFGetWaveFormatEx',
    'DISPID_SVEStreamStart', 'SPEI_RESERVED2',
    'DISPID_SGRSTPropertyValue', 'DISPID_SOTMatchesAttributes',
    'SPSHT_Unknown', 'DISPID_SPIEnginePrivateData', 'SREPhraseStart',
    'SAFT22kHz8BitStereo', 'SAFTCCITT_uLaw_11kHzMono', 'SVP_5',
    'STCAll', 'DISPID_SPEDisplayText', 'SPEI_SOUND_START',
    'SP_VISEME_1', 'SVEEndInputStream', 'SVESentenceBoundary',
    'SPBO_AHEAD', 'DISPID_SGRSTPropertyId', 'SRERequestUI',
    'DISPID_SADefaultFormat', 'SPEI_SR_PRIVATE',
    'DISPID_SOTIsUISupported', 'SPGRAMMARWORDTYPE',
    'SpeechRegistryUserRoot', 'SpMMAudioOut', 'SPEI_START_SR_STREAM',
    'SPSHT_EMAIL', 'DISPID_SRRTOffsetFromStart',
    'SPWORDPRONOUNCEABLE', 'DISPID_SLPSymbolic',
    'DISPID_SRGCmdLoadFromObject', 'eLEXTYPE_PRIVATE14', 'SRARoot',
    ...
    'SPAUDIOSTATUS', 'DISPID_SRGId', 'SAFTCCITT_uLaw_22kHzStereo',
    'DISPID_SPAStartElementInResult', 'SVSFUnusedFlags',
    'SGLexicalNoSpecialChars', 'DISPID_SRCPause',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SVGetAudioOutputs',
    'ISpeechGrammarRules', 'DISPID_SpeechObjectToken', 'SP_VISEME_7',
    'ISpNotifySource', 'SDA_One_Trailing_Space', 'SPSNoun',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SPCPhoneToId',
    'SpeechRecognitionType', 'ISpeechRecoGrammar',
    'eLEXTYPE_MORPHOLOGY', 'DISPID_SPPNumberOfElements',
    'DISPID_SGRSTPropertyName', 'SPEI_PHONEME', 'SPEVENTSOURCEINFO',
    'DISPID_SpeechXMLRecoResult', 'SAFTADPCM_8kHzStereo', 'SPAO_NONE',
    'eLEXTYPE_PRIVATE2', 'DISPID_SVSVisemeId', 'ISpeechVoiceStatus',
    'DISPID_SPRuleConfidence', 'SpeechWordPronounceable',
    'SP_VISEME_2', 'SVSFParseSapi', 'SpeechEmulationCompareFlags',
    'DISPID_SWFEExtraData', 'tagSPPROPERTYINFO', 'WAVEFORMATEX',
    'SPEI_PHRASE_START', 'DISPID_SpeechVoice', 'DISPID_SMSGetData',
    'SVPOver', 'SPXRO_SML', 'Speech_Max_Pron_Length',
    ...
    'SPEI_WORD_BOUNDARY', 'SPLO_DYNAMIC', 'SDKLLocalMachine',
    'SPRECOCONTEXTSTATUS', 'DISPID_SLPType', 'SAFTADPCM_44kHzMono',
    'DISPID_SPPFirstElement', 'SPCT_DICTATION', 'SPFM_OPEN_READONLY',
    'DISPID_SpeechObjectTokens', 'SREPropertyNumChange',
    'DISPID_SRStatus', 'SGSDisabled', 'SPRULESTATE',
    'DISPID_SLPsItem', 'SSFMCreateForWrite', 'DISPID_SASState',
    'SVEAllEvents', 'DISPID_SGRSTType', 'ISpeechResourceLoader',
    'DISPID_SRCEEndStream', 'SLTUser', 'SpeechAudioFormatGUIDWave',
    'ISpRecoGrammar', 'DISPID_SVSpeakCompleteEvent', 'SREAdaptation',
    'SPPHRASEREPLACEMENT', 'DISPID_SRRPhraseInfo',
    'DISPID_SRRTTickCount', 'ISpeechGrammarRuleStateTransitions',
    'SPWORDPRONUNCIATION', 'DISPID_SPIGetDisplayAttributes',
    'SpUnCompressedLexicon', 'SPEVENTENUM', 'SGLexical',
    'Speech_StreamPos_Asap', 'SREInterference', 'eWORDTYPE_ADDED',
    'SpPhoneticAlphabetConverter', 'SPDKL_CurrentConfig',
    'eLEXTYPE_PRIVATE18', 'SpeechDataKeyLocation', 'SFTInput',
    'DISPID_SBSWrite', 'SPAR_Unknown', 'DISPID_SPIStartTime',
    'ISpeechRecognizerStatus', 'SpeechRunState', 'ISpNotifySink',
    'LONG_PTR', 'SAFTCCITT_uLaw_8kHzMono', 'SREPrivate',
    'SVSFIsFilename', 'SAFTGSM610_22kHzMono', 'DISPID_SRDisplayUI',
    'IEnumSpObjectTokens', 'DISPID_SVResume',
    'SpeechCategoryRecoProfiles', 'SPTEXTSELECTIONINFO',
    'SSTTDictation', 'DISPID_SDKGetStringValue', 'SPEI_UNDEFINED',
    'DISPID_SOTsItem', 'DISPID_SPRuleFirstElement', 'SpVoice',
    'DISPIDSPRG', 'SPAR_Low', 'SPPS_SuppressWord', 'SPRST_ACTIVE',
    'SpMemoryStream', 'eLEXTYPE_PRIVATE12', 'SAFT32kHz16BitStereo',
    'ISpeechPhraseInfo', 'SPEI_VOICE_CHANGE', 'SECNormalConfidence'
]
